...
\begin{itemize}
\item \lstinline+WLED+\ --- классический ардуинский светодиод
\item \lstinline+XLED+\ --- второй светодиод на плате VLD\ref{STM32VLDISCOVERY} 
\end{itemize}

На платах STM32xxDISCOVERY светодиоды промаркированы LD3, LD4,.. 
На платах более толстых чипов их стоит до 8 штук (STM32F3DISCOVERY). 
